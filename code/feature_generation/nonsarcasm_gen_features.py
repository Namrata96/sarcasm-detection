...
f3 = codecs.open('/home/nam/Desktop/NLP/sarcasm_detection/Sarcasm-Detection-Twitter/test/data/test_nonsarcastic.txt', encoding='utf-8')
csvfile = open('/home/nam/Desktop/NLP/sarcasm_detection/Sarcasm-Detection-Twitter/test/data/nonsarcasm_gen_features.csv','wb')
...
f2 = open('/home/nam/Desktop/NLP/sarcasm_detection/Sarcasm-Detection-Twitter/test/data/processed_nonsarcastic.txt')

pattern=re.compile(r'\[(\-?[0-9])\]')
capital_count=[]
puncuation_count=[]
q=0
for idx,l in enumerate(f3) :
...
features_file = open("/home/nam/Desktop/NLP/sarcasm_detection/Sarcasm-Detection-Twitter/test/data/nonsarcasm_word_embedding_features.csv", 'w')
...
corpus = []
tweets = codecs.open('/home/nam/Desktop/NLP/sarcasm_detection/Sarcasm-Detection-Twitter/test/data/test_nonsarcastic.txt', encoding='UTF-8')
