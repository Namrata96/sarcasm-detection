...
import os
curr_dir = '/home/nam/Desktop/NLP/sarcasm_detection/Sarcasm-Detection-Twitter/code/svm/libsvm-3.21/python/'
os.chdir(curr_dir)
from svmutil import *
from svm import *
y, x = svm_read_problem('/home/nam/Desktop/NLP/sarcasm_detection/Sarcasm-Detection-Twitter/data/combined_libsvm_append_1.txt')
m = svm_train(y, x, '-c 4 -t 2')
y, x = svm_read_problem('/home/nam/Desktop/NLP/sarcasm_detection/Sarcasm-Detection-Twitter/test/data/combined_libsvm_append_1.txt')
