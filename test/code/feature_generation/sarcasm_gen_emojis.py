...
import codecs
import csv
f = codecs.open('/home/nam/Desktop/NLP/sarcasm_detection/Sarcasm-Detection-Twitter/test/data/test_sarcastic.txt', encoding='utf-8')
count=[]
t=[]
laughexp=[]
for l in f:
...
with open('/home/nam/Desktop/NLP/sarcasm_detection/Sarcasm-Detection-Twitter/test/data/sarcasm_emoji.csv','w') as csvfile:
